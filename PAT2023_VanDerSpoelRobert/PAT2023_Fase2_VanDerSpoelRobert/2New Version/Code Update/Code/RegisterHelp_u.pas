...
redHelp.Lines.Add('')  ;
redHelp.Lines.Add('-Name Should be at least 2 characters long.'+#13+'-You should be between 18 and 100 years old.'+#13+'-Username should be between 5 and 15 charaters long.'+#13+'-Password should be between 5 and 15 charaters long.') ;
